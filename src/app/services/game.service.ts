...
export class GameService implements OnInit, OnDestroy {
  ...
  public updateGameInfo(color_turn: boolean, threats_map: string[], oldInfo: GameInfo, deadTool: ToolInfo, gameStatus: string): void {
  ...
  private calcTimePass(time: number, lastDate): number {
